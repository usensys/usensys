...
-- The temporary solution for large data files: [usensys-balancing-model-data](https://www.dropbox.com/transfer/AAAAAP1eJGr_BoOzVpyeuxur8jcZNegmE8DOjFZfuQFDW56K9rRyMxo).  

* **v5.0** (Feb 22, 2020)  
-- Small adjustment according to the newer version of the *energyRt* package (v0.0.4).   
...
load(file.path(eiadir, "loadcurve.RData")) #lc
